...
const TIMEOUT_SEC = 10; // https://forkify-api.jonas.io
...
class RecipeView {
  ...
  `;
    ...
    <div class="message">
      <div>
        <svg>
        <use href="${(0, _iconsSvgDefault.default)}#icon.svg#icon-smile"</use>
        </svg>
        </div>
        <p>${message}</p>
    </div>
...
//# sourceMappingURL=Forkify App Building a Modern Application.4a59a05f.js.map
